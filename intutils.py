...
###
###  To use, import into a Jupyter notebook and call the interactive_plots() function,
...
def res(ra, dec, ang):
    """Fetches SDSS data with GetNearbyObj function with given parameters"""
    query = """
        SELECT
            s.ra, s.dec,
...
def plots(gsize, ra, dec, ang, style):
...
def interactive_plots():
    ...
    out = interactive_output(plots, {'gsize':gridSlider, 'ra':RABox, 'ra':RASlider, 'dec':DECBox, 'dec':DECSlider, 'ang':radBox, 'ang':radSlider, 'style':hexDrop})
